...
/**
 * <b>Bildklasse zur Darstellung einer Bilddatei</b><br/>
 *
 * @author Hans Witt, Claus Behl
 *
 * @version
 * Version 1 (4.12.08)<br/>
 * Version 5.0: (4.9.2010) 
 *  	   Entfernen f�r Graphikkomponente eingef�hrt<br/>
 *
 */
public class Bild implements IComponente {
	...
	public Bild(IContainer behaelter, int neuesX, int neuesY, int neueBreite,
		...
		/*
		 * if (bild != null) { setzeDimensionen(neuesX, neuesY, bild.getWidth(),
		 * bild.getHeight()); } else { setzeDimensionen(neuesX, neuesY,
